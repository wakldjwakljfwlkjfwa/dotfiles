...
vim.api.nvim_set_keymap('n', '<leader>lf', [[<Cmd>lua vim.lsp.buf.references()<CR>]], { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>u', [[<Cmd>lua vim.cmd.UndotreeToggle()<CR>]], { noremap = true, silent = true })
